 ...
 * Не является Spring-бином — создаётся для каждой генерации панели.
 * Зависимости (фабрики, контроллер) получает через конструктор.
 * Random и Scanner не являются бинами — создаются вручную.
 */
